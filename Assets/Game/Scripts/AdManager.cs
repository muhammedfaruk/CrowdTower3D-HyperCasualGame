...
public class AdManager : MonoBehaviour
{
    ...
    public bool unityAds = false;        //Set this false if you want to use Admob, set this true if you want to use Unity Ads!!!
    ...
    [SerializeField] private string bannerID = "ca-app-pub-3262407044435241/5131681918";
    [SerializeField] private string interstitialID = "ca-app-pub-3262407044435241/1437362373";
    ...
    void Awake()
    {
        ...
        if (firstTime)
        {
            ...
            admanagerInstance.RequestInterstitial();
